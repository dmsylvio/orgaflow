...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "How Orgaflow collects, uses, and protects your personal data.",
    url: "/privacy-policy",
    type: "website",
  },
  twitter: {
        ...
        <div className="prose prose-sm max-w-none text-foreground">
          ...
          {[
              ...
              content: (
                <>
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Organization data:</strong> company name, address,
                      tax information, and preferences you enter into your
                      workspace.
                    </li>
                    <li>
                      <strong>Business data:</strong> customers, estimates,
                      invoices, payments, tasks, and expenses you create within
                      the platform.
                    </li>
                    <li>
                      <strong>Billing information:</strong> payment details
                      processed securely by Stripe. We do not store card
                      numbers.
                    </li>
                    <li>
                      <strong>Usage data:</strong> pages visited, features used,
                      timestamps, IP address, browser type, and device
                      information.
                    </li>
                    <li>
                      <strong>Communications:</strong> messages you send to our
                      support team, including via the live chat widget (if
                      enabled).
                    </li>
                  </ul>
                </>
              ...
              content: (
                <>
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Tawk.to</strong> — customer support chat widget
                      (if enabled).
                    </li>
                    <li>
                      <strong>Resend / Nodemailer</strong> — transactional email
                      delivery.
                    </li>
                    <li>
                      <strong>PostgreSQL hosting provider</strong> — secure
                      database storage.
                    </li>
                    <li>
                      <strong>Vercel</strong> — platform hosting and edge
                      network.
                    </li>
                  </ul>
                  <p>
            ...
            },
            {
              ...
              content: (
                <p>
                  ...
                  you cancel your subscription, your data is retained for 30
                  days during which you can request an export. After this
                  period, your data is permanently deleted from our systems.
                  Some data may be retained longer to comply with legal
                  obligations.
                </p>
              ),
            },
            {
              ...
              content: (
                <p>
                  ...
                  encryption in transit, encrypted storage at rest, access
                  controls, and regular security reviews. However, no system is
              ...
              content: (
                <>
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Portability:</strong> export your business data in
                  ...
                  <p>
                    ...
                    <strong>app@orgaflow.dev</strong>.
                  </p>
                </>
              ),
            },
            {
              ...
              content: (
                <p>
                  ...
                  our service. For details, see our{" "}
                  <NextLink
                    href="/cookie-policy"
            ...
            },
            {
              ...
              content: (
                <p>
                  Orgaflow is not directed to children under 16. We do not
            ...
            },
            {
              ...
              content: (
                <p>
                  ...
                  within the platform at least 7 days before changes take
            ...
            },
            {
              ...
              content: (
                <p>
                  ...
                  contact us at <strong>app@orgaflow.dev</strong> or via our{" "}
                  <NextLink
                    href="/contact"
                    className="text-primary hover:underline"
                  >
