      ...
      <div className="space-y-4">
        <div className="rounded-2xl border border-border bg-muted/20 p-6 text-sm text-muted-foreground">
          {!canCreate
            ...
            : "This organization still needs a default currency, at least one customer, and at least one item before you can create invoices."}
        </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="space-y-1.5">
          <Label htmlFor="create-invoice-currency">Currency</Label>
          <Input
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_320px]">
        <div className="space-y-1.5">
          <Label htmlFor="create-invoice-notes">
            Notes{" "}
            <span className="text-xs text-muted-foreground">(optional)</span>
          </Label>
          <Textarea
