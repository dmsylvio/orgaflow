      ...
      <div className="space-y-4">
        <div className="rounded-2xl border border-border bg-muted/20 p-6 text-sm text-muted-foreground">
          {!canCreate
            ...
            : "This organization still needs a default currency, at least one customer, and at least one item before you can create estimates."}
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <div className="space-y-1.5">
          <Label htmlFor="create-estimate-customer">Customer</Label>
          <NativeSelect
        ...
        <div className="space-y-1.5">
          <Label htmlFor="create-estimate-currency">Currency</Label>
          <Input
            id="create-estimate-currency"
            value={meta.defaultCurrency?.code ?? ""}
            disabled
          />
        </div>
      </div>
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_320px]">
        <div className="space-y-1.5">
          <Label htmlFor="create-estimate-notes">
            Notes{" "}
            <span className="text-xs text-muted-foreground">(optional)</span>
          </Label>
          <Textarea
            id="create-estimate-notes"
            rows={5}
            value={notes}
