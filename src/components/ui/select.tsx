...
/**
 * NativeSelect — simple <select> element for forms that don't need the Radix dropdown.
 * Kept alongside the Radix-based Select for compatibility with existing form fields.
 */
