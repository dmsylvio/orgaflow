...
import { syncPermissionsCatalogToDatabase } from "@/server/iam/permissions/sync";
...
export const authRouter = router({
  signup: publicProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      // garante catálogo de permissões sincronizado
      await syncPermissionsCatalogToDatabase({ updateLabels: true });
