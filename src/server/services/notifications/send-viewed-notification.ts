...
<body style="margin:0;padding:0;background:#f4f6f9;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="padding:36px 40px;">
                ...
                <tr>
                  <td align="center" style="padding-bottom:24px;">
                    ...
                    <p style="margin:8px 0 0;font-size:14px;color:#64748b;">
                      A client just opened your ${label.toLowerCase()}
                    </p>
                  </td>
                </tr>
                      ...
                      <tr>
                        <td style="padding:20px 24px;">
                          <table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              <td>
                                <p style="margin:0;font-size:11px;font-weight:600;color:#94a3b8;text-transform:uppercase;letter-spacing:0.06em;">${label} number</p>
                                <p style="margin:4px 0 0;font-size:15px;font-weight:600;color:#2563eb;">${documentNumber}</p>
                              </td>
                            </tr>
                          </table>
                        </td>
                ...
                <tr>
                  <td align="center" style="padding-bottom:8px;">
                    <a href="${documentUrl}" style="display:inline-block;background:#2563eb;color:#ffffff;font-size:14px;font-weight:600;text-decoration:none;border-radius:8px;padding:13px 32px;">
                      View ${label} →
                    </a>
                  </td>
                </tr>
          ...
          <tr>
            <td align="center" style="padding:24px 0 8px;">
              <p style="margin:0;font-size:12px;color:#94a3b8;line-height:1.6;">
                You're receiving this because <strong>${label} viewed</strong> notifications<br/>are enabled in your
  ...
  const text = `${customerName} viewed your ${label} ${documentNumber}.\n\nOpen it here: ${documentUrl}`;
