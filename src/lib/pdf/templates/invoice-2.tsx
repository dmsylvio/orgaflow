...
const s = StyleSheet.create({
  ...
  hrLight: { borderBottomWidth: 0.5, borderBottomColor: C.border, marginVertical: 0 },
  addressRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    paddingTop: 20,
...
export function InvoicePdf2({ data }: { data: PdfTemplateData }) {
      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.headerBand}>
          ...
          <View style={s.headerRight}>
            <Text style={s.docTypeText}>INVOICE</Text>
          ...
          {data.secondaryDate ? (
            <View style={{ flexDirection: "row", justifyContent: "flex-end", marginBottom: 12 }}>
              <Text style={{ fontSize: 10, color: C.label, marginRight: 8 }}>
                {data.secondaryDateLabel ?? "Due Date"}
              </Text>
